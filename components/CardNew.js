...
class CardNew extends Component {
    ...
    submit = () => {
        ...
        if(question !== '' && answer !== '') {
            ...
            // update redux store
            this.props.dispatch(addQuestion({  title : title, question: question, answer: answer } ));
    ...
    render() {
        ...
        return (
            <KeyboardAvoidingView behavior='padding' style={styles.CardNew}>
